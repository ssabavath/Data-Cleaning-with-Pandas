...
- Cleaned individual columns (formatted values)
- Handled missing values (NaN)
- Applied additional data transformations for better structure
...
3. Performed cleaning operations step-by-step
4. Exported cleaned dataset for further analysis
